...
| Script | Description |
|--------|-------------|
| `python -m scripts.last_entry` | Get last logbook entry |
| `python -m scripts.last_entry --count 5` | Get last N entries |
| `python -m scripts.last_entry --date-only` | Get just the date |
...
```bash
# Last logbook entry
.venv/bin/python -m scripts.last_entry

# Last 5 entries
.venv/bin/python -m scripts.last_entry --count 5

# Last entry date only
.venv/bin/python -m scripts.last_entry --date-only

# Missing dates this month
